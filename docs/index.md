...
1- PHP source code targeted in backdoor attack ?   
2- PHP Site's User Database Was Hacked     
3- POC Script    
...
In the malicious commits seen by BleepingComputer, the attackers published a mysterious change upstream, "fix typo" under the pretense this was a minor typographical correction. 
